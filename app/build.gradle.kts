...
android {
    namespace = "com.yigitberk.composerestaurantdesign_2026"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.yigitberk.composerestaurantdesign_2026"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(libs.androidx.navigation.compose) //Added for navigating
